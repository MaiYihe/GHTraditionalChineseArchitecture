...
{
    public class 水平贯通_无斗栱屋架 : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the 竖直贯通 class.
        /// </summary>
        public 水平贯通_无斗栱屋架()
          : base("水平贯通_无斗栱屋架", "Nickname",
              "Description",
              "Yhm Toolbox", "形体设计")
        {
        }
        ...
        {
            pManager.AddGenericParameter("水平贯通线", "SPGTX", "", GH_ParamAccess.list);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Curve curve0 = new Line(p0,p1).ToNurbsCurve();
            curves.Add(curve0);
            if (index>0 && index <= columnVertex.Count/2)
            {
        ...
        {
            get { return new Guid("D7D11ED6-BBA3-4625-993B-065EE0EB6A52"); }
        }
    }
}